...
<img src="https://img.shields.io/github/stars/engrmaziz/collab?style=for-the-badge" />
</a>

<a href="https://github.com/engrmaziz/collab/network/members">
<img src="https://img.shields.io/github/forks/engrmaziz/collab?style=for-the-badge" />
</a>

<a href="https://github.com/engrmaziz/collab/issues">
<img src="https://img.shields.io/github/issues/engrmaziz/collab?style=for-the-badge" />
</a>

<a href="https://github.com/engrmaziz/collab/pulls">
<img src="https://img.shields.io/github/issues-pr/engrmaziz/collab?style=for-the-badge" />
</a>

<a href="LICENSE">
<img src="https://img.shields.io/github/license/engrmaziz/collab?style=for-the-badge" />
</a>
...
<a href="#">
<img src="https://img.shields.io/badge/Realtime-Supabase-3FCF8E?style=for-the-badge" />
</a>
...
<a href="#">
<img src="https://img.shields.io/badge/Vite-6-646CFF?style=for-the-badge" />
</a>
...
<img src="https://skillicons.dev/icons?i=react,ts,vite,tailwind,supabase,postgres,nodejs,npm,vercel,git,github,vscode,md&perline=7" />
...
User A->>Browser: Edit Markdown

Browser->>Supabase: Save Changes

Supabase-->>User B: Broadcast Update

User B->>Browser: Receive Event

Browser-->>User B: Update Editor
```
...
flowchart TD
    User --> Login_Page
    Login_Page --> Supabase_Auth
    Supabase_Auth --> JWT_Session
    JWT_Session --> Protected_Routes
...
DOCUMENTS ||--o{ SNAPSHOTS : contains
DOCUMENTS ||--o{ COLLABORATORS : shared_with
```
...
User A->>Supabase: Update

Supabase-->>User B: Broadcast

User B->>Supabase: Edit

Supabase-->>User A: Broadcast
```
...
User A->>Server: Edit Document

Server-->>User B: Broadcast Change

User B->>Server: Edit Document

Server-->>User A: Broadcast Change
```
...
```mermaid
flowchart LR
    A["🔌 Join Channel"] --> B["🟢 Presence Tracking"]
    B --> C["📡 Broadcast Updates"]
    C --> D["👥 Connected Users"]
```
